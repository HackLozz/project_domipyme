...
export default function EditProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => nav("/merchant/products"), 1500);
    } catch (err) {
  ...
  if (!form) {
    return (
      <div style={styles.container}>
        <div style={styles.errorBox}>{error || "No se pudo cargar el producto"}</div>
        <Link to="/merchant/products" style={styles.btnBack}>← Volver a productos</Link>
      </div>
    );
  }
  ...
  return (
    <div style={styles.container} className={mounted ? 'page-enter' : ''}>
      ...
      <div style={styles.header}>
        ...
        <h2 style={styles.h2}>Editar producto</h2>
        <p style={styles.subtitle}>Actualiza la información del producto</p>
      </div>

      <div style={styles.card}>
        {success && (
          <div style={styles.successBox}>✓ Producto actualizado exitosamente</div>
        )}
